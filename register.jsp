...
<head>
    ...
    <title>Register · BO4 Meta Loadouts</title>
    <style>
...
<div class="auth-container">
    <div class="auth-box">
        ...
        <div class="auth-subtitle">Join to build and share your own loadouts.</div>
        ...
        <form method="post" action="${pageContext.request.contextPath}/register">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username"
                       placeholder="YourCallsign" required maxlength="30">
            </div>
            <div class="form-group">
